        ...
        <div class="w-full mx-auto space-y-6">
            ...
            <div class="space-y-4">
                @include('project-planning.human-resource.partials.sub-header', [
                    'breadcrumb' => __('PLANNING') . ' / ' . __('HUMAN RESOURCE') . ' / ' . __('ALOCATE TEAM'),
                    'title' => __('Alokasi & Kapasitas Tim'),
                    'description' => __('Manage personnel workloads and allocate strategic roles to ensure the timely success of the project.'),
                    'project' => $project,

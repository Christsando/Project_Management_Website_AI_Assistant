                                    ...
                                    <tr class="hover:bg-slate-50/30 transition duration-150">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @elseif($hrStatus === 'draft')
                                                <span class="inline-flex items-center gap-1 py-1 px-2.5 rounded-lg text-[10px] font-extrabold border bg-slate-55 text-slate-600 border-slate-200">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="inline-flex gap-2">
                                                @if($isBudgetFinalized)
                                                    @if($hrStatus === 'none')
                                                        @if($isPmo)
                                                            <a href="{{ route('projects.human-resource.create', $project->id) }}" class="inline-flex items-center justify-center px-3.5 py-2 text-xs font-bold text-white bg-[#0B1329] hover:bg-slate-800 rounded-xl shadow-sm transition gap-1.5">
                                                    ...
                                                    @elseif($hrStatus === 'draft')
                                                        @if($isPmo)
                                                            <a href="{{ route('projects.human-resource.edit', $project->id) }}" class="inline-flex items-center justify-center px-3.5 py-2 text-xs font-bold text-white bg-slate-900 hover:bg-slate-800 rounded-xl shadow-sm transition gap-1.5">
                                                                <i class="fas fa-edit text-[9px]"></i> {{ __('Kelola HR Plan') }}
                                                            </a>
                                                        @else
                                                            <a href="{{ route('projects.human-resource.show', $project->id) }}" class="inline-flex items-center justify-center px-3.5 py-2 text-xs font-bold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 rounded-xl shadow-sm transition gap-1.5">
                                                ...
                                                @else
                                                    <span class="text-xs text-slate-400 italic font-semibold py-2 px-3 block flex items-center gap-1">
                                                        <i class="fas fa-lock text-[9px]"></i> {{ __('Menunggu Anggaran Final') }}
                                                    </span>
                                                @endif
                                            </div>
                                        </td>

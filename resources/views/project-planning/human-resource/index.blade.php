                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="inline-flex gap-2">
                                                @if($isBudgetFinalized)
                                                    @if($hrStatus === 'none')
                                                        @if($isPmo)
                                                            <a href="{{ route('projects.human-resource.create', $project->id) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-600 hover:text-white shadow-sm transition">
                                                                <i class="fas fa-plus mr-1.5"></i> {{ __('Buat HR Plan') }}
                                                            </a>
                                                        @else
                                                    ...
                                                    @elseif($hrStatus === 'draft')
                                                        @if($isPmo)
                                                            <a href="{{ route('projects.human-resource.edit', $project->id) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-amber-700 bg-amber-50 border border-amber-200 rounded-lg hover:bg-amber-600 hover:text-white shadow-sm transition">
                                                                <i class="fas fa-edit mr-1.5"></i> {{ __('Kelola HR Plan') }}
                                                            </a>
                                                        @else
                                                            <a href="{{ route('projects.human-resource.show', $project->id) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-gray-900 shadow-sm transition">
                                                                <i class="fas fa-eye mr-1.5 text-gray-400"></i> {{ __('Detail HR Plan') }}
                                                            </a>
                                                        @endif
                                                    @else
                                                        <a href="{{ route('projects.human-resource.show', $project->id) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-gray-900 shadow-sm transition">

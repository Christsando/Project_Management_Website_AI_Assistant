            ...
            <div class="bg-white rounded-xl border border-[#e3e3e0] shadow-sm p-6">
                <form action="{{ route('projects.budget.store', $project->id) }}" method="POST">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                        <a href="{{ route('project-planning.budget.index') }}" class="px-4 py-2 border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-xl text-sm font-semibold transition">
                            {{ __('Batal') }}
                        </a>

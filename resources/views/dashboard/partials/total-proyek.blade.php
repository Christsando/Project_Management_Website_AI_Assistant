<div class="border border-slate-200 bg-gradient-to-br from-blue-600 to-gradientBlue rounded-2xl p-5 shadow-sm hover:scale-[1.01] transition-all duration-300 flex flex-col justify-between">
    ...
    <div class="flex items-center justify-between">
        <span class="card-title">{{ __('Total Proyek') }}</span>
    ...
    <div class="flex items-baseline justify-between mt-2 mb-2 ms-2">
        <span class="text-4xl font-black text-white tracking-tight">{{ $totalProjects }}</span>
    </div>

    <!-- progress of the content value -->
    <!-- change to dynamic data if fix -->
    <div class="flex gap-3 items-center text-sm text-blue-200">

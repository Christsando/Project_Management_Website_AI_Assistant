...
<div class="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
    ...
    <div class="flex justify-around items-end h-52 px-4 pb-2 border-b border-slate-100">
        ...
        <div class="flex flex-col items-center gap-2">
            <div class="h-40 w-14 bg-slate-200/70 rounded-full relative overflow-hidden flex flex-col justify-end">
                <div class="bg-blueColor rounded-full w-full" style="height: 70%;"></div>
            </div>
            <!-- month footer -->
        ...
        <div class="flex flex-col items-center gap-2">
            <div class="h-40 w-14 bg-slate-200/70 rounded-full relative overflow-hidden flex flex-col justify-end">
                <div class="bg-blueColor rounded-full w-full" style="height: 10%;"></div>
            </div>
            <!-- month footer -->
            <span class="text-[10px] text-slate-400 font-bold">{{ __('Jan') }}</span>
        </div>
        ...
        <div class="flex flex-col items-center gap-2">
            <div class="h-40 w-14 bg-slate-200/70 rounded-full relative overflow-hidden flex flex-col justify-end">
                <div class="bg-blueColor rounded-full w-full" style="height: 30%;"></div>
            </div>
            <!-- month footer -->
            <span class="text-[10px] text-slate-400 font-bold">{{ __('Jan') }}</span>
        </div>
        ...
        <div class="flex flex-col items-center gap-2">
            <div class="h-40 w-14 bg-slate-200/70 rounded-full relative overflow-hidden flex flex-col justify-end">
                <div class="bg-blueColor rounded-full w-full" style="height: 80%;"></div>
            </div>
            <!-- month footer -->
            <span class="text-[10px] text-slate-400 font-bold">{{ __('Jan') }}</span>
        </div>
        ...
        <div class="flex flex-col items-center gap-2">
            <div class="h-40 w-14 bg-slate-200/70 rounded-full relative overflow-hidden flex flex-col justify-end">
                <div class="bg-blueColor rounded-full w-full" style="height: 40%;"></div>
            </div>
            <!-- month footer -->
            <span class="text-[10px] text-slate-400 font-bold">{{ __('Jan') }}</span>
        </div>

                                                ...
                                                @if($isWbsFinalized)
                                                    @if($timelineStatus === 'none')
                                                        @if($userRole === 'pmo' || $userRole === 'project management officer')
                                                            <a href="{{ route('projects.timeline.create', $project->id) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-600 hover:text-white shadow-sm transition">
                                                                <i class="fas fa-plus mr-1.5"></i> {{ __('Buat Timeline') }}
                                                            </a>
                                                        @else
                                                        ...
                                                        @endif
                                                    @else
                                                        <a href="{{ route('projects.timeline.show', $project->id) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-gray-900 shadow-sm transition">
                                                            <i class="fas fa-eye mr-1.5 text-gray-400"></i> {{ __('Detail Timeline') }}
                                                        </a>
                                                    @endif
                                                @else
                                                    <span class="text-xs text-gray-400 italic font-medium py-1.5 px-3 block">
                                                        {{ __('Menunggu Finalisasi WBS') }}
                                                    </span>
                                                @endif
                                            </div>
                                        </td>

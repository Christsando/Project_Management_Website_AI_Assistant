                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                            ...
                            <div class="border-b border-slate-50 pb-4 mb-5 flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 mt-1 font-medium">{{ __('Kebutuhan mitigasi, probabilitas, keparahan, dan pemilik risiko.') }}</p>
                                </div>
                        ...
                        <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
                            ...
                            @if(empty($aiSuggestions))
                                <div class="text-center py-8">
                                    ...
                                    <p class="text-xs text-slate-400 italic px-4 leading-relaxed">{{ __('Belum ada rekomendasi AI. Klik tombol di bawah untuk menganalisis risiko proyek.') }}</p>
                                </div>
                            @else
                                    ...
                                    @foreach($aiSuggestions as $idx => $sug)
                                        ...
                                        <div class="cursor-pointer p-4 bg-slate-50 border border-slate-100 hover:border-blue-500 hover:bg-slate-50/50 rounded-xl transition duration-200 group"
                                            ...
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <i class="fas fa-arrow-right text-slate-400 group-hover:text-blue-500 text-xs transition duration-200"></i>
                                            </div>
                            ...
                            <form action="{{ route('projects.risk-management.generate_ai', $project->id) }}" method="POST" onsubmit="document.getElementById('ai-spinner').classList.remove('hidden'); document.getElementById('ai-btn-text').innerText='{{ __('Menganalisis...') }}';">
                                @csrf
                                <button type="submit" class="w-full py-2.5 bg-white border border-dashed border-slate-300 hover:border-blue-500 hover:text-blue-600 rounded-xl text-xs font-bold text-slate-500 transition duration-200 flex items-center justify-center gap-1.5 shadow-sm mt-4">
                    ...
                    <div class="bg-white px-6 pt-6 pb-4">
                        ...
                        <div class="space-y-4 max-h-[450px] overflow-y-auto pr-1">
                            ...
                            <div>
                                ...
                                <input type="text" name="risk_title" id="add_risk_title" required placeholder="Contoh: Keterlambatan Integrasi API Pihak Ketiga" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="risk_description" id="add_risk_description" required rows="2" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50" placeholder="Jelaskan detail mengenai skenario risiko..."></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="risk_cause" id="add_risk_cause" rows="2" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50" placeholder="Penyebab utama dari risiko tersebut..."></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="impact" id="add_impact" required rows="2" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50" placeholder="Dampak yang dirasakan pada jadwal/biaya/tim jika terjadi..."></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="mitigation_plan" id="add_mitigation_plan" required rows="2" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50" placeholder="Tindakan pencegahan sebelum risiko terjadi..."></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="contingency_plan" id="add_contingency_plan" rows="2" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50" placeholder="Langkah pemulihan jika risiko benar-benar terjadi..."></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="risk_owner" id="add_risk_owner" placeholder="Contoh: Project Manager" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="notes" id="add_notes" rows="2" class="w-full text-xs font-semibold rounded-xl border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-400 bg-slate-50/50" placeholder="Catatan internal..."></textarea>
                            </div>
                        </div>
                    </div>

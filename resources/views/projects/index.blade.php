    ...
    <x-slot name="header">
        <div class="flex bg-white border border-slate-100 shadow-sm rounded-2xl p-4 items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2">
                <h1 class="text-2xl font-bold tracking-tight text-blue-900">{{ __('Daftar Proyek') }}</h1>
            </div>
            ...
            <div class="relative w-80">
                ...
                <input type="text" id="project-search-input" onkeyup="searchProjects()" placeholder="Cari proyek..." 
            ...
            <div class="flex items-center gap-5">
                ...
                <div class="flex items-center gap-3 pl-4 border-l border-slate-200">
                    ...
                    <!-- Logout Link -->
                    <form id="header-logout-form-list" method="POST" action="{{ route('logout') }}" class="hidden">
                        @csrf
                    </form>
                    <a href="#" onclick="event.preventDefault(); document.getElementById('header-logout-form-list').submit();" 
